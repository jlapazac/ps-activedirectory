...
$UserToDelete = Get-AzureADUser -SearchString "testing@testing.onmicrosoft.com"

if($null -eq $UserToDelete){
   write-host("Crear usuario")
}else {
    Remove-AzureADUser -ObjectId "testing@testing.onmicrosoft.com"
}
...
New-AzureADUser -DisplayName "Testing" -PasswordProfile $PasswordProfile -UserPrincipalName "testing@testing.onmicrosoft.com" -AccountEnabled $true -MailNickName "testing" -JobTitle "Usuario" -Department "Operacion" -UsageLocation "PE" -UserType "Member"
...
Set-AzureADUserLicense -ObjectId "testing@testing.onmicrosoft.com" -AssignedLicenses $licenses
